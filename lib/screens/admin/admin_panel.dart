...
class link extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(builder:(context)=>DriverDetailsToAdmin(trucker: trucker, img: img)));
      },
      child: Container(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Text(trucker.name.toString().toUpperCase(), style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.w500),overflow: TextOverflow.fade, ),
                      Text("Plate: ${trucker.numberPlate}", style: TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.w500))
                    ],
                  ),
                  Icon(Icons.star_border_outlined, color: Colors.white, size: 50,),
                ],
